module.exports = {
    ...
    punishmentRequested: 'punishment_requested',
    punishmentAccepted: 'punishment_accepted',
    punishmentRejected: 'punishment_rejected',
    punishmentIgnored: 'punishment_ignored',
